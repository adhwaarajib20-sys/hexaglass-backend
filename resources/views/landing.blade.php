...
<body class="bg-white text-gray-900">
    ...
    <nav class="fixed top-0 left-0 right-0 bg-white bg-opacity-95 backdrop-blur-md z-50 shadow-md" x-data="{ open: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <!-- CTA Button -->
                <a href="https://web-production-fc4fb.up.railway.app" target="_blank" class="hidden md:inline-block bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-6 py-2 rounded-lg font-semibold transition-smooth">
                    Download Aplikasi
                </a>
            </div>
            ...
            <div x-show="open" class="md:hidden pb-4 space-y-2" x-transition>
                ...
                <a href="https://web-production-fc4fb.up.railway.app" target="_blank" class="block bg-gradient-to-r from-green-600 to-green-700 text-white px-4 py-2 rounded-lg font-semibold mt-4">
                    Download Aplikasi
                </a>
            </div>
        </div>
    ...
    <section id="beranda" class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://web-production-fc4fb.up.railway.app" target="_blank" class="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-8 py-4 rounded-lg font-bold text-lg transition-smooth hover:shadow-2xl hover:glow-green">
                    Download Aplikasi
                </a>
    ...
    <section class="py-20 bg-gradient-to-r from-green-600 via-green-600 to-orange-500 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10" data-aos="fade-up" data-aos-duration="1000">
            ...
            <a href="https://web-production-fc4fb.up.railway.app" target="_blank" class="inline-block bg-white text-green-600 px-10 py-4 rounded-lg font-bold text-lg hover:bg-green-50 transition-smooth hover:shadow-2xl">
                Download Sekarang →
            </a>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="https://web-production-fc4fb.up.railway.app" target="_blank" class="hover:text-green-400 transition-smooth">Download Aplikasi</a></li>
                        <li><a href="https://web-production-fc4fb.up.railway.app/login" target="_blank" class="hover:text-green-400 transition-smooth">Login Aplikasi</a></li>
